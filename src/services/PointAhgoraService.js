...
class PointAhgoraService {
  async beatTime () {
    ...
    try {
      ...
      await page.$eval('#account_i', function (el) { el.value = '00109' })

      await page.waitForSelector('#password_i')
      await page.$eval('#password_i', function (el) { el.value = 'Fe260493' })
...
export default new PointAhgoraService()
